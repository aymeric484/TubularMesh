...
#define DISTANCE_MIN 0.20
#define COURBURE_MAX 0.35 // diverge en dessous de 0.0004 => probablement des NaN dans les calculs de courbures => ne viendrait pas de l'algo
