...
#define DISTANCE_MIN 0.8
#define COURBURE_MAX 0.7 // diverge en dessous de 0.0004 => probablement des NaN dans les calculs de courbures => ne viendrait pas de l'algo
